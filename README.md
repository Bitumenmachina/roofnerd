...
| **Condition** | One thing you traced, with its properties — pitch, height, width, number of sides. A single condition yields square feet, linear feet and a count at the same time, because a parapet run is all three. |
